...
import { AiFillHome, AiFillStar, AiOutlineCluster, AiOutlineSchedule, AiOutlineUser } from "react-icons/ai";
...
const ECommerce: React.FC = () => {
	...
	const getDataList = async () => {
		...
		const response: any = await COMMON_API.getList('statistic', params);
		setLoading(false);
