...
const SignIn: React.FC = () => {
	...
	const onSubmit = async (e: any) => {
		...
		setLoading(true)
		const response: any = await AUTH_SERVICE.login(form);
		setLoading(false)
			...
			<div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
				<div className="flex flex-wrap items-center">
					{!openView ? <>
						...
						<div className=" py-5 h-screen md:flex md:justify-center md:gap-5 md:items-center">
							<div className=" md:max-h-[500px]">
								<h3 className="text-center mb-5 text-3xl">Điều hướng trang</h3>
								<div className="md:flex md:gap-5 md:justify-center md:items-center">
									<button className="cursor-pointer rounded-lg border 
									
										border-primary bg-primary p-6 sm:flex sm:gap-5 items-center
										text-white transition hover:bg-opacity-90"
										onClick={(e) => {
											e.preventDefault();
											setItem("view", "USER");
									...
									<button className="cursor-pointer rounded-lg border 
										border-primary bg-success p-6 sm:flex sm:gap-5 items-center
										text-white transition hover:bg-opacity-90"
										onClick={(e) => {
											e.preventDefault();
											setItem("view", "ORDER");
